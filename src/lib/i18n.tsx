...
const translations = {
  EN: {
    ...
    hero: {
      ...
      subtitle1: "Voice memos that automatically update your CRM in 40 seconds.",
      subtitle2: "Save 5+ hours per week.",
      subtitle3: "Get back to selling.",
      cta1: "Start Free Trial",
      cta2: "Watch 40-Second Demo",
    ...
    features: {
      ...
      f1: { title: "Instant Processing", desc: "40-second updates. Not 10 minutes of manual typing between meetings." },
    ...
    solution: {
      ...
      title2: "CRM Data",
      title3: "in 40 Seconds.",
      subtitle: "A frictionless workflow that keeps your pipeline updated without opening your laptop.",
      s1: { title: "RECORD", time: "20s", desc: "Walk to your car. Tap record. Talk naturally:" },
      s2: { title: "EXTRACT", time: "12s", desc: "AI extracts structured data instantly:" },
      s3: { title: "SYNC", time: "8s", desc: "CRM updated automatically. Drive to your next meeting." },
  ...
  ES: {
    ...
    hero: {
      ...
      subtitle1: "Notas de voz que actualizan automáticamente tu CRM en 40 segundos.",
      subtitle2: "Ahorra más de 5 horas a la semana.",
      subtitle3: "Vuelve a vender.",
      cta1: "Prueba gratuita",
      cta2: "Ver demo de 40s",
    ...
    features: {
      ...
      f1: { title: "Procesamiento Instantáneo", desc: "Actualizaciones en 40 segundos. No 10 minutos de escritura manual entre reuniones." },
    ...
    solution: {
      title1: "De voz a",
      title2: "datos CRM",
      title3: "en 40 segundos.",
      subtitle: "Un flujo de trabajo sin fricciones que mantiene tu pipeline actualizado sin abrir el portátil.",
      s1: { title: "GRABAR", time: "20s", desc: "Ve al coche. Pulsa grabar. Habla con naturalidad:" },
      s2: { title: "EXTRAER", time: "12s", desc: "La IA extrae datos estructurados al instante:" },
      s3: { title: "SINCRONIZAR", time: "8s", desc: "CRM actualizado automáticamente. Ve a tu próxima reunión." },
