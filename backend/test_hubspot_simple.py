"""
Simple test script for HubSpot integration.

Tests only the HubSpot service layer without requiring full app dependencies.
"""
...
# Add backend/app to path for proper imports
