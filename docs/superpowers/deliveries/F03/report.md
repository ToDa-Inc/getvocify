...
Estado: el memo del dashboard muestra las mismas líneas cuando el memo tiene contacto de HubSpot. La extensión las pinta al abrir el contacto y las esconde en una captura. El Companion en home las muestra cuando ya conoce el contacto de HubSpot (sin pantalla CRM completa).
