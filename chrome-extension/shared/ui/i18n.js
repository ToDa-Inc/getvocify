...
const STRINGS = {
  es: {
    ...
    desktopLoginEmail: 'Email',
    desktopLoginPassword: 'Contraseña',
    desktopLoginSubmit: 'Entrar',
    desktopReviewSummary: 'Resumen',
    desktopReviewNext: 'Próximos pasos',
    desktopReviewCrm: 'CRM',
    desktopReviewApprove: 'Aprobar en CRM',
  ...
  en: {
    ...
    desktopLoginEmail: 'Email',
    desktopLoginPassword: 'Password',
    desktopLoginSubmit: 'Sign in',
    desktopReviewSummary: 'Summary',
    desktopReviewNext: 'Next steps',
    desktopReviewCrm: 'CRM fields',
    desktopReviewApprove: 'Approve to CRM',
