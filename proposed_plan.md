...
**Fuentes canónicas:** este maestro manda sobre alcance/decisiones/secuencia; el catálogo de contratos manda sobre interfaces compartidas; cada plan de entrega conserva su UX, edge cases y detalle de ejecución. Los planes históricos PF/S se reutilizan donde se indique, con las correcciones explícitas de esta revisión. Un cambio de contrato exige actualizar productor y consumidores antes de implementar; no hay 16 diseños independientes.
...
| F03 | Preparación previa | Resúmenes y próximos pasos existentes; formato de cuatro filas propuesto en I §2.4 y §3.3. | Servicio de lectura y componente compartido. **Formato pendiente de aprobación**, según tu respuesta. |
...
|---|---|
| Preparación previa | **Pendiente por decisión expresa tuya.** Validar las cuatro filas y la extensión sobre el contacto HubSpot como superficie primaria; dashboard/desktop como secundarios. Estados vacíos y navegación ya propuestos en F03. No implementar hasta validar. |
| Developer ID y distribución macOS | **Pendiente de Dani.** Confirmar existencia/alta de cuenta Apple Developer, acceso a Developer ID y responsable de credenciales. La ingeniería de firma/notarización queda condicionada a esa decisión; no se asume una cuenta ni se contrata en esta sesión. Captura, continuidad visual, marca y build interno pueden avanzar. |
...
- [x] **A3 — Preparación:** [F03](/Users/danizal/getvocify/docs/superpowers/plans/2026-09-22-vocify-v1/09-f03-preparacion.md) propone extensión sobre contacto HubSpot como superficie primaria, `screen-contact`, accesos secundarios, estados sin historial y navegación segura; la aprobación sigue pendiente.
